...
Bot.currentActionIndex := 1

; Questing configs

Bot.desiredZones       := [ Patterns.Zone[5]]
...
; GVG config
Bot.GVGBadgeChoice    := 5    ; 1–5
Bot.GVGOpponentChoice := 3    ; 1–4

Bot.Raid := {}
Bot.Raid.Conf := {}
; Raid configs
Bot.Raid.Conf.List := ["Raid11"] ; List of raids to run. MATCH THESE TO Patterns.Raid.RaidName
...
Bot.WorldBoss.Conf.Difficulty := "Normal" ; Add Difficulty setting (Normal, Hard, Heroic)
