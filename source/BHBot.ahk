...
if (A_IsCompiled = 1) 
{
msgbox This is an early release build V0.3 of the BHBot from https://github.com/very-inky/Bit-HeroesBot subject to GNU GPL v3 License. By using this bot you are agreeing to the terms laid out in the license. More info can be found here https://www.gnu.org/licenses/gpl-3.0.en.html
msgbox It is highly encouraged to report any bugs, broken features or issues via our discord @ http://discord.gg/wEvJ8cmcYf or the issues section on the github project.
msgbox Lastly, make sure you have the config.cfg and game options configured as specified, or else the bot will hang!
...
Text:="|<>0xFFFFFF@1.00$21.TU03w00TU03w00TU03w00w007U00w007U00w007U00QQ03XU0QQ00000000000000000000004"
;Gold pot check
 if (ok:=FindText(726-150000, 761-150000, 726+150000, 761+150000, 0, 0, Text))
 {
   CoordMode, Mouse
   X:=ok.1.x, Y:=ok.1.y, Comment:=ok.1.id
   Click, %X%, %Y%
...
{
sleep 300000
bhaccheck = %bhaccheck% + 1 ;the idea is once this gets to 3 we will revisit AutoUse to check for expired buffs
goto teamclose
}



;potentially after all checks have been done for the script, do a 
;sleep x
;goto teamclose
...
;declines shard purchase prompt. Inky from the future here, the image search here is completely fucking unecessary, you could just set the var and go to teamclose since it loops pressing the escape key,
;all menues and prompts would close.
Raidcheck = 1
