...
class PvpActionConfigTest {
    ...
    fun testPvpConfigCustomValues() {
        ...
        val pvpConfig = PvpActionConfig(
            ...
            specificTemplates = listOf("templates/buttons/pvp_opponent_1.png"),
            ticketsToUse = 3,
            opponentRank = 4,
        ...
        assertEquals("templates/buttons/pvp_button.png", pvpConfig.commonActionTemplates[0])
        assertEquals(1, pvpConfig.specificTemplates.size)
        assertEquals("templates/buttons/pvp_opponent_1.png", pvpConfig.specificTemplates[0])
